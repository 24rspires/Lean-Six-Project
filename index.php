...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>Boker Real Estate - Lean Six Cert</title>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						...
						<p>
							Discover our latest listings featuring unique architectural designs and modern amenities, tailored to elevate your lifestyle.</p>
					</div>
				</div>
				<div class="row">
					<div class="col-md-4 animate-box">
						<div class="property">
							...
							<div class="property-details">
								<h3>186 London Rd, Delaware, OH 43015</h3>
								<span class="price">$259,900</span>
								<p>
									Indulge in the tranquility of this sprawling ranch-style abode, offering serene countryside living.</p>
							</div>
						</div>
					</div>
					<div class="col-md-4 animate-box">
						<div class="property">
							...
							<div class="property-details">
								<h3>7000 Duncans Glen Dr, Westerville, OH 43082</h3>
								<span class="price">$4,199,900</span>
								<p>
									Luxurious mansion: water views, chef's kitchen, elevator, basketball court, deluxe amenities.</p>
							</div>
						</div>
					</div>
					<div class="col-md-4 animate-box">
		...
		<div id="fh5co-about" class="fh5co-agent">
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						<h3>Lean Six Team</h3>
						<p>We are the ones who developed this website, alongside the database to go with the website.</p>
					</div>
				</div>
				<div class="row">
