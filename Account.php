...
class Account {
    ...
    public function getProfilePicture()
    {
        ...
        return "images/agents/default-agent-profile-picture.png";
    }

    public static function getAgents() : array|false {
        $result = dbhelper::getInstance()->query("SELECT * FROM accounts WHERE type=1");
